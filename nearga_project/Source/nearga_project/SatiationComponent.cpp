...
void USatiationComponent::TakeHungerDamage()
{
	...
	//UWidgetHUD.UpdateSatiation(CurrentSatiation, MaxSatiation);
	//AHUD* PlayerHUD = GetWorld()->GetFirstPlayerController()->GetHUD();
	//PlayerHUD->WidgetHUD->UpdateSatiation(CurrentSatiation, MaxSatiation);
}
